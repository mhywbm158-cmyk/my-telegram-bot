...
def main():
    ...
    app.add_handler(CallbackQueryHandler(admin_action_ban, pattern='^adm_ban_'))
    app.add_handler(CallbackQueryHandler(admin_action_warn, pattern='^adm_warn_'))
    app.add_handler(CallbackQueryHandler(lambda u,c: u.callback_query.answer(), pattern='^adm_ignore$'))
    ...
    print("🚀 Bot is running with WHISPER and DONATION features...")
    app.run_polling()
